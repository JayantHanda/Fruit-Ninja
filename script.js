...
cursorimage.src = "images/knife.png";
...
function Fruit(x, y, dx, dy, r, image) {
    this.x = x;
    this.y = y;
    this.dx = dx;
    this.dy = dy;
    ...
    this.update = function () {
        ...
        if (this.screencheck === true && (this.x - this.r > window.innerWidth || this.x + this.r < 0 || this.y - this.r > window.innerHeight || this.y + this.r < 0)) {
            lives -= 1
            this.screencheck = false
        }
    };
...
function spawnFruit() {
    ...
    for (var i = 0; i < number1; i++) {
        ...
        fruitarray.push(new Fruit(x, y, dx, dy, r, image));
    }
}
